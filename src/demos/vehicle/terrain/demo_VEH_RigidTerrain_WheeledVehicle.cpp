...
int main(int argc, char* argv[]) {
    ...
    RigidTerrain terrain(hmmwv.GetSystem(), vehicle::GetVehicleDataFile("terrain/RigidPatches.json"), true);
#else
    ...
    if (true) {
        ...
        patch1->SetTexture(vehicle::GetVehicleDataFile("terrain/textures/tile4.jpg"), 20, 20);
        ...
        patch2->SetTexture(vehicle::GetVehicleDataFile("terrain/textures/concrete.jpg"), 20, 20);
        ...
        auto patch3 = terrain.AddPatch(patch3_mat, ChCoordsys<>(ChVector3d(0, -42, 0), QUNIT),
                                       vehicle::GetVehicleDataFile("terrain/meshes/bump.obj"));
        patch3->SetColor(ChColor(0.5f, 0.5f, 0.8f));
        patch3->SetTexture(vehicle::GetVehicleDataFile("terrain/textures/dirt.jpg"), 6.0f, 6.0f);
    ...
    if (false) {
        ...
        auto patch = terrain.AddPatch(patch_mat, ChCoordsys<>(ChVector3d(0, 0, 10), QUNIT),
                                      vehicle::GetVehicleDataFile("terrain/multilayer/multilayer-terrain.obj"));
    }
